    ...
    try:
        conn.execute(
            ...
            CREATE TABLE IF NOT EXISTS short_share_links (
                ...
                first_email_provider_message_id VARCHAR,
                first_email_template_key VARCHAR,
...
def _ensure_video_crop_schema(conn) -> set:
    ...
    definitions = [
        ...
        ("subtitle_preset", "VARCHAR", DEFAULT_SUBTITLE_PRESET),
        ("title_margin", "INTEGER", DEFAULT_TITLE_MARGIN),
        ("title_line_spacing", "INTEGER", -4),
        ("title_bg_color", "VARCHAR", DEFAULT_EDITOR_TITLE_BG_COLOR),
        ("title_bg_alpha", "INTEGER", DEFAULT_EDITOR_TITLE_BG_ALPHA),
        ("title_text_color", "VARCHAR", DEFAULT_EDITOR_TITLE_TEXT_COLOR),
