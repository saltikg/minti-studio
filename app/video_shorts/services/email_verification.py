...
def _resend_payload(
    *,
    ...
    resolved_from_email = (from_email or "").strip() or mail_from
    payload: dict[str, object] = {
        "from": formataddr((resolved_from_name, resolved_from_email)),
        "to": [to_email],
        "subject": subject,
        "html": html,
        "text": text,
...
def send_resend_email(
    *,
    ...
    logger.info(
        ...
        formataddr((resolved_from_name, resolved_from_email)),
